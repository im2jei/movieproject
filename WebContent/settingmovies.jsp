...
<body>
	...
	<form action="MovieServlet?command=insertmovie"
		enctype="multipart/form-data" method="post">
		<div class="wrapper wrapper--w680">
			<div class="card card-1">
				<div class="card-body">
					<h2 class="title">insert movies</h2>
					<div class="input-group">
						<input class="input--style-1" type="text" placeholder="Title"
							name="title">
					</div>
						...
						<div class="col-2">
							<div class="input-group">
								<input class="input--style-1 js-datepicker" type="text"
									placeholder="Opening Date" name="date"> <i
					...
					<div class="input-group">
						<input class="input--style-1" type="text"
							placeholder="url address" name="src">
					</div>
					<div class="input-group">
						<textarea id="TextArea" placeholder="Summary" name="summary">
</textarea>
					</div>
				</div>

				<div class="input-group">
					<input class="input--style-1" type="file" name="uploadFile">
				</div>
